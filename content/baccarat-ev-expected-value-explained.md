...
期望值（EV）是將同一動作重複無限多次後，平均每次會賺到或虧掉的金額，是衡量下注是否划算的核心指標。
...
在標準八副牌百家樂中，莊注 EV 為 -1.06%、閒注 -1.24%、和注 -14.36%，三個注區全部是負期望值。
...
會，百家樂的 EV 是動態的——每發出一張牌，剩餘牌堆的組成就改變，各注區的期望值也隨之波動。這是整篇文章最重要的段落。
...
一靴牌從頭到尾，莊注 EV 可能從 -1.06% 波動到接近 0% 甚至翻正，波動幅度隨牌靴推進而增大。理論講夠了，來看真實數據。
...
正確運用 EV 的核心原則是：只在期望值相對有利時出手，其餘時間觀望，並用 EV 而非直覺選擇注區。理解了 EV 之後，最關鍵的問題是：怎麼用？
