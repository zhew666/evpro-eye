...
export const metadata: Metadata = {
  title: "常見問題 FAQ",
  description:
    "百家之眼常見問題：什麼是百家之眼、EV 怎麼算、體驗方式、支援平台等。",
  alternates: { canonical: "https://evpro-eye.com/faq" },
  openGraph: {
    title: "常見問題 FAQ — 百家之眼",
    description:
      "百家之眼常見問題：什麼是百家之眼、EV 怎麼算、體驗方式、支援平台等。",
    url: "https://evpro-eye.com/faq",
  },
};
...
const faqs = [
  {
    question: "百家之眼是什麼？",
    answer:
      "百家之眼是一套百家樂 EV（期望值）即時分析系統。我們使用窮舉法精確計算每一手牌的 EV，並透過 LINE 即時推播數據給使用者。簡單來說，我們用數學幫你看懂每一手牌的真實價值。",
  },
  {
    question: "EV 期望值怎麼算的？",
    answer:
  ...
  },
  {
    question: "需要下載 APP 嗎？",
    answer:
      "不需要。百家之眼目前透過 LINE 提供服務，只要有 LINE 就能使用。未來我們也會推出 PWA 網頁版，讓你直接在瀏覽器使用，同樣不需要安裝任何程式。",
  },
  {
    question: "百家之眼能保證贏錢嗎？",
    answer:
  ...
  },
  {
    question: "如何開始使用？",
    answer:
      "三步驟就能開始：1) 掃碼或點擊連結加入百家之眼 LINE 好友；2) 在聊天室輸入推薦碼即可開通體驗資格；3) 開始使用指令查詢預期收益數據。整個過程不到一分鐘。",
  },
  {
    question: "推薦碼是什麼？",
    answer:
      "推薦碼是我們的推薦獎勵機制。每位用戶都有專屬推薦碼，當你的朋友透過你的推薦碼加入並訂閱，你和你的朋友都能獲得額外的使用天數。詳情請在 LINE 中輸入相關指令查詢。",
  },
];
